...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="雅尼"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="138****0131"/>
		<input type="hidden" name="orderShipping.receiverState" value="河北"/>
		<input type="hidden" name="orderShipping.receiverCity" value="秦皇岛"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="东北大学"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="5153"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">雅尼</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">138****0131</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">河北秦皇岛</div>
						<div class="adr-m" limit="30">东北大学5153</div>
